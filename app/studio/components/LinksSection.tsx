...
export default function LinksSection({ links, onAdd, onDelete, textColorStyle }: LinksSectionProps) {
  return (
    <div className="mb-8">
        ...
        <div className="space-y-2">
          {links.map((link) => (
            <div key={link.id} className="bg-white/10 backdrop-blur-sm rounded-xl p-4 shadow-sm flex items-center gap-3">
              ...
              <button onClick={() => onDelete(link.id)} className="p-2 rounded-full hover:bg-red-500/20 transition">

/*
  ...
  - You are about to drop the column `secondaryColor` on the `Portal` table. All the data in the column will be lost.
...
INSERT INTO "new_Portal" ("avatar", "backgroundImage", "bio", "createdAt", "gradientEnd", "gradientStart", "id", "primaryColor", "slug", "templateId", "textColor", "title", "updatedAt", "userId") SELECT "avatar", "backgroundImage", "bio", "createdAt", "gradientEnd", "gradientStart", "id", "primaryColor", "slug", "templateId", "textColor", "title", "updatedAt", "userId" FROM "Portal";
DROP TABLE "Portal";
